...
import 'package:ezy_learn/UI/ParentsSection/parents_taskpage.dart';
import 'package:flutter/material.dart';

class ParentsTaskNextPage extends StatefulWidget {
  @override
  _ParentsTaskNextPageState createState() => _ParentsTaskNextPageState();
}

class _ParentsTaskNextPageState extends State<ParentsTaskNextPage> {
  @override
        ...
        child: Row(
          ...
          children: [
            TaskPage_Button("Today", Color(0xff3F2E3F), () {
               Navigator.push(context, MaterialPageRoute(builder: (context)=>ParentsTaskPage()));
            }),
            SizedBox(
